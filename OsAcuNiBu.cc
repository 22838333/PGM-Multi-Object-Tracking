...
int main(int, char *argv[]) {
  try {
    ...
    mnEx[0] = 0; mnEx[1] = 0; mnEx[2] = 0; mnEx[3] = 0; mnEx[4] = 0; mnEx[5] = 0;
    covEx(0,0) = 100000.0; covEx(0,1) = 0.0; covEx(0,2) = 0.0; covEx(0,3) = 0.0; covEx(0,4) = 0.0; covEx(0,5) = 0.0;
    covEx(1,0) = 0.0; covEx(1,1) = 100000.0; covEx(1,2) = 0.0; covEx(1,3) = 0.0; covEx(1,4) = 0.0; covEx(1,5) = 0.0;
