...
int main(int argc, char *argv[]) {
  try {
    ...
    covEx(0,0) = 1000.0; covEx(0,1) = 0.0; covEx(0,2) = 0.0; covEx(0,3) = 0.0; covEx(0,4) = 0.0; covEx(0,5) = 0.0;
    covEx(1,0) = 0.0; covEx(1,1) = 1000.0; covEx(1,2) = 0.0; covEx(1,3) = 0.0; covEx(1,4) = 0.0; covEx(1,5) = 0.0;
